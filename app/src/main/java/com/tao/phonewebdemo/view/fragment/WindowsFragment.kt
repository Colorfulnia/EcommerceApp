...
import com.tao.phonewebdemo.databinding.FragmentWindowsBinding
...
class WindowsFragment : Fragment(), SubCategoryMVP.SubCategoryView, CommunicatorProduct {
    ...
    override fun onCreateView(
        ...
        binding = FragmentWindowsBinding.inflate(layoutInflater, container, false)
